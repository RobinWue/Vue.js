/* Tablehead dynamisch rendern mit computed property
   Nur Bücher von O`Reilly Media anzeigen lassen durch computedproperty
   Preise mit 20% Rabatt anzeigen
*/
Vue.createApp({
  data() {
    return {
  ...
  methods: {
    calculateDiscountedPrice(price) {
      ...
      return (numericPrice * 0.8).toFixed(2);
    },
  },
}).mount("#app");
